...
const Profile = () => {
  ...
  useEffect(() => {
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyABeIBY3N4MdMe1Qgj7rhDCW0whYVK6ug4",
      {
        method: "POST",
        body: JSON.stringify({
  ...
  const updateHandler = (event) => {
    ...
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyABeIBY3N4MdMe1Qgj7rhDCW0whYVK6ug4",
      {
        method: "POST",
        body: JSON.stringify({
          idToken: authCtx.token,
